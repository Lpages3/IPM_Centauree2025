...
extractAIC(Flowglm1) ; extractBIC(Flowglm1, n)
extractAIC(Flowglm2) ; extractBIC(Flowglm2, n)
extractAIC(Flowglm3) ; extractBIC(Flowglm3, n)
extractAIC(Flowglm4) ; extractBIC(Flowglm4, n)
extractAIC(Flowglm5) ; extractBIC(Flowglm5, n)
