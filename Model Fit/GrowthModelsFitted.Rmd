...
Growthglm2 <- fitme(log(Size1Mars) ~ 1 + poly(log(Size0Mars),4) + poly(age0,3) + (log(Size0Mars)|year) + (log(Size0Mars)|Pop),
                    data=growthdata)

Growthglm3 <- fitme(log(Size1Mars) ~ 1 + bs(log(Size0Mars),df=3,degree=2) + poly(age0,3) + (log(Size0Mars) + age0|year) + (log(Size0Mars)|Pop),
                    data=growthdata)

Growthglm4 <- fitme(log(Size1Mars) ~ 1 + poly(log(Size0Mars),3) + bs(age0,degree=2,knots=6.5) + (log(Size0Mars)|year) + (log(Size0Mars)|Pop),
                    data=growthdata)

Growthglm5 <- fitme(log(Size1Mars) ~ 1 + poly(log(Size0Mars),3) + poly(age0,3) + (1|year) + (log(Size0Mars)|Pop),
                    data=growthdata)
```
