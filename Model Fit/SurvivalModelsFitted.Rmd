...
BIC
```{r}
Survglm1 <- fitme(SurvieMars ~ 1+ poly(Size0Mars,3) + (1|year) + (1|Pop),
                  family=binomial,
                  data=survdata1,
                  method="PQL/L")

Survglm2 <- fitme(SurvieMars ~ 1+ poly(Size0Mars,3) + (Size0Mars|year) + (1|Pop),
                  family=binomial,
                  data=survdata1,
                  method="PQL/L")

Survglm3 <- fitme(SurvieMars ~ 1+ poly(Size0Mars,4) + (1|year) + (1|Pop),
                  family=binomial,
                  data=survdata1,
                  method="PQL/L")

Survglm4 <- fitme(SurvieMars ~ 1+ bs(Size0Mars,df=5,degree=3) + (1|year) + (1|Pop),
                  family=binomial,
                  data=survdata1,
                  method="PQL/L")
...
```{r}
Survglm1 <- fitme(SurvieMars ~ 1 + bs(Size0Mars,df=3,degree=2) + (1|year) + (1|Pop),
                  family=binomial,
                  data=survdata2,
                  method="PQL/L")

Survglm2 <- fitme(SurvieMars ~ 1 + bs(Size0Mars,df=3,degree=2) + (1|year),
                  family=binomial,
                  data=survdata2,
                  method="PQL/L")

Survglm3 <- fitme(SurvieMars ~ 1 + poly(Size0Mars,3) + (1|year) + (1|Pop),
                  family=binomial,
                  data=survdata2,
                  method="PQL/L")

Survglm4 <- fitme(SurvieMars ~ 1 + bs(Size0Mars,df=3,degree=2) + (age0|year),
                  family=binomial,
                  data=survdata2,
                  method="PQL/L")

Survglm5 <- fitme(SurvieMars ~ 1 + poly(Size0Mars,3) + (1|year),
                  family=binomial,
                  data=survdata2,
                  method="PQL/L")
```
