...
#Load functions
source("/media/loic/Commun/0Travail/2025 IPM Centauree ISEM/2025 Stage ISEM/Code/IPM/Results/Kernal analysis/Perturbation analysis - Griffith 2017/Perturbation Functions (Copy).R")
  
#Get mean values for discretized vital rate functions
S <- sx01(ymid.a,a)
Fl <- flr0(ymid.a, a)
G <- Gyx3(ysup=yI.a[,2], yinf=yI.a[,1], x=ymid, a=age)
