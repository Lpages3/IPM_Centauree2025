...
validNrw <- Filter(is_valid_Nrw,combi) # Combinaisons fonctionelles (comprenant l'effet individu) - pour la survie
...
combi_growthNrw_log <- lapply(validNrw, function(x) gsub("Size0Mars", "log(Size0Mars)", x))
