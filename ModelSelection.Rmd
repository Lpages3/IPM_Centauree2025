...
# Add interaction effect (Pop:year) and individual effect
random_effects <- c(as.vector(ran_combinations),"(1|Pop:year)","1","(1|Individu)")
```
...
# Remove interaction effect
interaction_combination <- function(comb){
